(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@styled-system/should-forward-prop'), require('styled-components'), require('@styled-system/css'), require('styled-system'), require('use-events'), require('prop-types'), require('use-onclickoutside'), require('@reach/auto-id'), require('@popperjs/core'), require('flushable'), require('react-dom'), require('prismjs'), require('prism-react-renderer'), require('@reach/alert'), require('@reach/rect'), require('react-transition-group/Transition')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@styled-system/should-forward-prop', 'styled-components', '@styled-system/css', 'styled-system', 'use-events', 'prop-types', 'use-onclickoutside', '@reach/auto-id', '@popperjs/core', 'flushable', 'react-dom', 'prismjs', 'prism-react-renderer', '@reach/alert', '@reach/rect', 'react-transition-group/Transition'], factory) :
  (global = global || self, factory(global['@blockstack/ui'] = {}, global.React, global.shouldForwardProp, global.styled, global.css, global.styledSystem, global.useEvents, global.propTypes, global.useOnClickOutside, global.autoId, global.core, global.flushable, global.reactDom, global.Prism, global.Highlight, global.ReachAlert, global.rect, global.CSSTransition));
}(this, (function (exports, React, shouldForwardProp, styled, css, styledSystem, useEvents, propTypes, useOnClickOutside, autoId, core, flushable, reactDom, Prism, Highlight, ReachAlert, rect, CSSTransition) { 'use strict';
  ...
  var CSSReset = /*#__PURE__*/styled.createGlobalStyle( /*#__PURE__*/_templateObject$3(), cssReset);
  var ScopedCSSReset = /*#__PURE__*/styled__default.div( /*#__PURE__*/_templateObject2(), borderColor, placeholderColor, placeholderColor, placeholderColor);
  ...
  function Tooltip(props) {
    ...
    }, tooltipProps), label, hasAriaLabel && React.createElement(VisuallyHidden, Object.assign({}, hiddenProps), ariaLabel), hasArrow && React.createElement(Box, Object.assign({
      "data-arrow": "",
      bg: "inherit"
    }, getArrowProps())))));
  }
