...
var authenticate = function authenticate(_ref) {
  ...
  try {
    ...
    if (!userSession) {
      var appConfig = new AppConfig(['store_write'], document.location.href); // eslint-disable-next-line no-param-reassign
...
var Intro = function Intro() {
  ...
  }, "Get started")), React.createElement(ScreenFooter, null, React.createElement(Stack, {
    mb: "base-loose",
    mt: "base-tight",
    spacing: "base",
    isInline: true
  ...
  }, "I already have a Secret Key"), React.createElement(Link, {
    color: "blue",
    textStyle: "caption",
    onClick: function onClick() {
...
export { Connect, Link, PoweredBy, Screen, ScreenActions, ScreenBody, ScreenFooter, ScreenHeader, ScreenLoader, Title, authenticate, popupCenter, showBlockstackConnect, useConnect };
